-- Pokemon Stadium 1-2 Overworld Models (Gen 1-2)
--
-- Supports both Generation 1 (Red/Blue/Yellow) with Stadium 1 ROM (151 Pokemon)
-- and Generation 2 (Gold/Silver) with Stadium 2 ROM (251 Pokemon).
-- This file does not contain any Pokemon Stadium assets.  It reuses Dramatic Shape's
-- Stadium model packs after the player has built them from their own compatible ROM.
local mod = ...

-- Detect the active game generation to use the appropriate Stadium ROM
...
local stadiumName = isGen2() and "Pokemon Stadium 2" or "Pokemon Stadium"
...
function V.require(name)
  ...
  if name == "StadiumRom2" then return loadLocal("lib/StadiumRom2.lua", V) end
