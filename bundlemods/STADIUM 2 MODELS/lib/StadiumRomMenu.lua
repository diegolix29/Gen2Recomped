...
-- for: baseroms/stadium.z64 (Gen 1) or baseroms/stadium2.z64 (Gen 2).
local V = ...
local M = {}
...
local STAGE_PATH = "baseroms/" .. (gameGeneration() == 2 and "stadium2.z64" or "stadium.z64")
...
local function consumeAndroidPick(game)
  ...
  -- Dramatic Shape's Android helper scans baseroms/stadium.z64 (Gen 1) or
  -- baseroms/stadium2.z64 (Gen 2). Normalize .v64/.n64 byte orders so every
  -- Android picker selection lands at the exact canonical path without asking
  -- the player to rename/copy it.
