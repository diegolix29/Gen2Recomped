...
--
-- Accepted tags are National Dex numbers (1..251 for Gen 2, 1..151 for Gen 1) or engine species strings.
local V = ...
...
local function builtInFollowerDex(entity)
  ...
  if okFollower and StadiumFollower and type(StadiumFollower.getSpecies) == "function" then
    ...
    if followerSpecies and followerSpecies > 0 and followerSpecies <= 251 then
