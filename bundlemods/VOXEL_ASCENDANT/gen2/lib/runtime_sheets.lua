...
-- Sheets live under assets/vasc_runtime/followsprites_runtime/ (build-time).
--
-- Path types (do not mix):
--   relativePath  — mod-root relative, e.g. assets/vasc_runtime/.../001-normal.png
--   loadPath      — engine virtual path via mod.assets:path(relativePath)
--                   e.g. mods/overworld_wild_spawns/assets/vasc_runtime/.../001-normal.png
--
...
RuntimeSheets.DIR_REL = "assets/vasc_runtime/followsprites_runtime"
