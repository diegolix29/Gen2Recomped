...
WaterSpriteRegistry.RUNTIME_REL = "assets/vasc_runtime/water_runtime"
...
WaterSpriteRegistry.SILHOUETTE_RUNTIME = {
  swimming = "assets/vasc_runtime/swimming_silhouette_runtime",
  levitates = "assets/vasc_runtime/levitates_silhouette_runtime",
}
