...
function AmbientPokemon:_makeNpc(game, ow, species, x, y, behavior)
  ...
  -- Match the Gen2 NPC constructor: raw Game2 data and the compatibility
  -- facade expose different registry names. An empty Gen1 registry must not
  -- suppress valid Gen2 residents (or admit a wrong-generation placeholder).
  local sprites = rawget(game.data, "gen2Sprites") or game.data.sprites
