# Upstream DramaticShapeVoxelMod v1.6.1 changelog (historical)

> This file is retained for license/provenance history. It describes upstream
> features, including systems intentionally removed from Voxel Ascendant. See
> `CHANGELOG.md` and `README.md` for the current product.
