# Legendary 3D Character Selector

Battle Art-compatible build of the 3D Character Selector for Gen1Recomp 0.2.53.
The current tested package is **TEST111**, which preserves the working selector,
3D battle trainer, living idle and Poké Ball handoff while repairing explicit
overworld-player ownership through Legendary Battle Art's actor-provider seam.

This compatibility build replaces TEST110. Disable older Character Selector
builds, install only the release ZIP, and fully restart the game.
