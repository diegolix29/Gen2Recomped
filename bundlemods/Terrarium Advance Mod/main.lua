...
local function initializeColosseumIntegration()
  ...
  local function installColosseumRuntime(force)
    ...
    if CurrentSpriteModels and type(CurrentSpriteModels.registerCapability) == "function" and PokemonActors and PokemonActors.service then
      pcall(CurrentSpriteModels.registerCapability, "DRAMATIC_SHAPE/pokemon", "battleActors", PokemonActors.service)
    end
  ...
  -- Pokemon models service for external mod access (same as CBE)
  mod.exports.pokemonModels = PokemonActors and PokemonActors.service or nil
